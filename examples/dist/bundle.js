...
var Async = (0, _createReactClass2['default'])({
	propTypes: {
		...
		children: _propTypes2['default'].func, // Child function responsible for creating the inner Select component; (props: Object): PropTypes.element
		...
		searchingText: _propTypes2['default'].string // message to display while options are loading
	},
...
},{"./Select":"react-select-plus","./utils/stripDiacritics":23,"create-react-class":2,"prop-types":11,"react":undefined}],14:[function(require,module,exports){
'use strict';
...
},{"./Select":"react-select-plus","create-react-class":2,"react":undefined}],15:[function(require,module,exports){
'use strict';
...
},{"./Select":"react-select-plus","./utils/defaultFilterOptions":21,"./utils/defaultMenuRenderer":22,"create-react-class":2,"prop-types":11,"react":undefined}],16:[function(require,module,exports){
'use strict';
...
},{"create-react-class":2,"prop-types":11,"react":undefined}],17:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined}],20:[function(require,module,exports){
"use strict";
...
var Select = (0, _createReactClass2['default'])({
  ...
  */
	...
	renderClear: function renderClear() {
		if (!this.props.clearable || !this.props.value || this.props.value === 0 || this.props.multi && !this.props.value.length || this.props.disabled || this.props.isLoading) {
			return;
		}
		return _react2['default'].createElement(
			'span',
...
},{"./Async":13,"./AsyncCreatable":14,"./Creatable":15,"./Dropdown":16,"./Option":17,"./OptionGroup":18,"./Value":19,"./utils/defaultArrowRenderer":20,"./utils/defaultFilterOptions":21,"./utils/defaultMenuRenderer":22,"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined,"react-dom":undefined,"react-input-autosize":undefined}]},{},[]);
